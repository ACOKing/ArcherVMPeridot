...
SET "TMP=%~dp0tmp"
SET "PERL5LIB="
SET "Path=%~dp0apps\drupal\drush;%~dp0apps\drupal\drush\bin;;%~dp0;%~dp0php;%~dp0perl\site\bin;%~dp0Git2\bin%~dp0perl\bin;%~dp0apache\bin;%~dp0mysql\bin;%~dp0FileZillaFTP;%~dp0MercuryMail;%~dp0sendmail;%~dp0webalizer;%~dp0tomcat\bin;%Path%"
GOTO :EOF
:weiter
